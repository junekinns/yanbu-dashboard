...
- [X] T037 자체 위기 점수 철회 ("자체척도가 무슨 의미냐"): `crisis_summary`·`CRISIS_LEVELS`·`summary` 블록 삭제. 상단 배지는 주요 5곳 중 최고 **외교부 단계**(공식 척도, 공식 색)이고 옆에 사실 칩 4개(72시간 피격·공습 / 후티 7일 주요 도시 지목 / 30일 단계 변경 / 이번 주 공지). 헤드라인 줄은 배지에 흡수. US8 스펙은 "공식 척도 + 사실"로 대체된 것으로 본다.
